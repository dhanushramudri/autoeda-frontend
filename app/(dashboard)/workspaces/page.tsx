    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-card rounded-2xl shadow-2xl w-full max-w-md p-6">
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={onClose}
            className="flex-1 py-2 border border-border rounded-lg text-sm font-medium text-foreground hover:bg-muted transition"
          >
            Cancel
          </button>
          <button
...
function WorkspaceCard({ workspace }: { workspace: Workspace }) {
  ...
  return (
    <>
      <div className="bg-card rounded-xl border border-border hover:border-brand/30 hover:shadow-md transition group flex flex-col overflow-hidden">
        {/* Main clickable area */}
        <Link
        ...
        <div className="border-t border-border flex divide-x divide-border">
          <Link
            ...
            onClick={handleClick}
            className="flex-1 flex items-center justify-center gap-1.5 py-2 text-[10px] font-medium text-muted-foreground hover:text-brand hover:bg-brand/10 transition"
          >
